...
define run_or_attach
	@if docker ps --format '{{.Names}}' | grep -q "^$(CONTAINER_NAME)$$"; then \
		printf "\033[0;32mContainer $(CONTAINER_NAME) is running.\033[0m\n"; \
		printf "\033[0;36mAttaching zsh...\033[0m\n"; \
		docker exec -it $(CONTAINER_NAME) zsh; \
	else \
		printf "\033[0;33mCreating new container $(CONTAINER_NAME)...\033[0m\n"; \
		$(call docker_run,$(2),$(1)); \
	fi
endef
